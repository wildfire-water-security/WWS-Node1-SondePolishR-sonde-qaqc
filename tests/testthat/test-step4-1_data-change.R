...
test_that("{shinytest2} recording: checking-module4-1", {
  ...
  app$click("data5-apply_limits-apply_flags")
  app$set_inputs(`data5-apply_limits-confirm_full_save` = TRUE, allow_no_input_binding_ = TRUE, priority_ = "event",wait_ = FALSE)
  plot_obj <- app$get_value(export = "data5-plot_obj")
  expect_snapshot_value(get_plotly_snap(plot_obj), style = "json2")
  ...
  app$set_inputs(`data5-apply_limits-confirm_full_save` = FALSE, allow_no_input_binding_ = TRUE, priority_ = "event",wait_ = FALSE)
