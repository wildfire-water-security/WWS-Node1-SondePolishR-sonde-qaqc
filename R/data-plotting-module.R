## module to plot with options

# UI
#' @rdname plot-data
#' @export
plotting_data_UI <- function(id) {
  ns <- NS(id)
  tagList(
      sidebarLayout(
        sidebarPanel(
...
# Server
#' Shiny module to plot data from sondeproj with options
#'
#' Used to nicely package all the plotting options so it can be reused.
#'
#' @param id An ID string passed to shiny::NS(), used for namespacing UI inputs/outputs.
#' @param sondeproj A `reactiveVal` holding the current dataset.
#'
#' @returns a `plotly` objection
#' @md
#' @export
#' @keywords internal
#' @rdname plot-data
