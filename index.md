...
function which can be used outside the app to move from the raw data set
to the cleaned dataset or can be used to “undo” changes and go from the
cleaned data to the raw data.
